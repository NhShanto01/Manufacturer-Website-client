...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        {
            user && <li><Link to="/dashboard/manageproduct">All Products</Link></li>
        }
        ...
        <li>{user ? <button className='btn btn-ghost'
            onClick={logout}
        >Log Out</button> : <NavLink to="/login">Login</NavLink>}</li>
    ...
    return (
        <div className="navbar bg-black">
            <div className="navbar-start">
                ...
                <a href='/' className="btn btn-ghost normal-case text-2xl text-yellow-400">Auto Parts</a>
            </div>
